...
public class UpcomingBirthdayActivity extends Activity {
...
static	String[] filenames;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ab.setTitle("Upcoming Birthdays");
...
//		Toast.makeText(getBaseContext(), "Value of i" + i, Toast.LENGTH_SHORT)
//				.show();
...
//			temp = sp.getString("FileName" + k, null);
	...
	public void setList() {
		...
		// prev = curr;
		//
		// relative_layout.addView(tv2, params3);
		//
		// 3
